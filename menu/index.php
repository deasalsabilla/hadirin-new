...
// Ambil data menu
$result = $conn->query("SELECT * FROM data_menu ORDER BY urutan ASC");
...
<head>
    ...
    <title>Data Menu - Sistem Absensi</title>
    <!-- Bootstrap 5 CSS -->
            ...
            <div class="content">
                <?php if ($success): ?>
                    <div class="alert alert-success">
                        ...
                        <span>
                            <?php
                            if ($success === 'tambah') echo 'Data menu berhasil ditambahkan!';
                            elseif ($success === 'edit') echo 'Data menu berhasil diperbarui!';
                            elseif ($success === 'hapus') echo 'Data menu berhasil dihapus!';
                            ?>
                        </span>
                    </div>
                <?php endif; ?>
                ...
                <div class="card">
                    <div class="card-header">
                        <h2><i class="bi bi-people"></i> Daftar Menu</h2>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="tabelMenu" class="table table-striped table-bordered nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama Menu</th>
                                        ...
                                        while ($row = $result->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <i class="<?= htmlspecialchars($row['icon_menu']); ?>"></i>
                                                </td>
                                                <td><?= htmlspecialchars($row['link_menu']); ?></td>
                                                ...
                                                <td class="text-center">
                                                    <a href="edit.php?id=<?= $row['id_menu']; ?>" class="btn btn-sm btn-warning">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                    <a href="hapus.php?id=<?= $row['id_menu']; ?>" class="btn btn-sm btn-danger">
